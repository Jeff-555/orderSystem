...
import com.springboot.sell.converter.OrderMaster2OrderDTOConverter;
...
import com.springboot.sell.service.*;
 ...
 * @Date: 2022/1/8 15:58
 * KeyUtil自定义、随机生成主键
 * 不是测试的Transactional注解，执行成功是不会回滚的
 */
@Service
@Slf4j
...
//        List<CartDTO> cartDTOList = new ArrayList<>();
        ...
        for (OrderDetail orderDetail : orderDTO.getOrderDetailList()
            ...
            //传入所有商品id对应order_detail columns
...
//        spring依赖CollectionUtils自带isEmpty方法
    ...
    @Override
    //TODO:查询用户所有订单，但不输出订单详情，如果需要则自行修改
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable) {
        // orderMasterPage可以为空，不用判断
